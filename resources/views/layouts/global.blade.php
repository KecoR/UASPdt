   ...
   <div class="wrapper ">
     ...
     -->
       ...
       <div class="sidebar-wrapper">
         <ul class="nav">
           <li class="nav-item">
             <a class="nav-link" href="{{ route('nomor1') }}">
               <i class="material-icons">looks_one</i>
               <p>Nomor 1</p>
             </a>
           </li>
           <li class="nav-item ">
             <a class="nav-link" href="{{ route('nomor2') }}">
               <i class="material-icons">looks_two</i>
               <p>Nomor 2</p>
             </a>
           </li>
           <li class="nav-item ">
             <a class="nav-link" href="{{ route('nomor3') }}">
               <i class="material-icons">looks_3</i>
               <p>Nomor 3</p>
             </a>
           </li>
           <li class="nav-item ">
             <a class="nav-link" href="{{ route('nomor4') }}">
               <i class="material-icons">looks_4</i>
               <p>Nomor 4</p>
             </a>
           </li>
           <li class="nav-item ">
             <a class="nav-link" href="{{ route('nomor5') }}">
